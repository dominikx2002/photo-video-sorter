...
def scan_source(src, allowed_extensions=None):
    """Quick pre-scan: counts media files, their total size, and lists which
    folders/extensions they belong to. Used by the wizard's Step 1 to
    preview what will happen (including a disk-space check in Step 2), and
    again at the start of run_sort() to size the progress bar."""
        ...
        for name in filenames:
            ...
            if ext in allowed:
                ...
                try:
                    ...
                    pass
    return {"total": total, "folders": len(folders), "by_ext": by_ext, "total_size": total_size}
